...
public class GUIProducts extends javax.swing.JFrame {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        campos = productService.saveProduct(txtName.getText(), txtDescription.getText());
        if (campos == false) {
            JOptionPane.showMessageDialog(null,"Campo(s) faltante(s)", "Atención",JOptionPane.ERROR_MESSAGE);
        }else {
            JOptionPane.showMessageDialog(null,"Producto agregado", "Atención",JOptionPane.INFORMATION_MESSAGE);
            cleanControls(); 
        }
